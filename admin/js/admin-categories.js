Object.assign(I18N.en, {
  ...
  admin_categories_subtitle: 'Explore the live hierarchy and prototype category changes locally.',
  admin_categories_add: 'Add category',
  admin_categories_local_note_title: 'Frontend prototype',
  admin_categories_local_note: "Category changes stay in this browser's admin overlay and never update the live API or storefront.",
  ...
  admin_categories_table_caption: 'Categories from the live catalog with browser-local admin changes applied',
  ...
  admin_categories_local_edit: 'Browser-local change',
  ...
  admin_categories_icon_help: 'For this local admin view only.',
  admin_categories_field_enabled: 'Enabled in this admin view',
  admin_categories_form_note: 'Submitting changes only the local admin overlay in this browser.',
  admin_categories_cancel: 'Cancel',
  admin_categories_apply_local: 'Apply locally',
  ...
  admin_categories_loading_body: 'Reading the live hierarchy and applying this browser’s local overlay.',
  ...
  admin_categories_source_local: 'Local only',
  admin_categories_source_edited: 'Live + local edit',
  ...
  admin_categories_saving: 'Applying locally…',
  admin_categories_added_local: '“{name}” was added only to this browser’s admin overlay.',
  admin_categories_updated_local: '“{name}” was updated only in this browser’s admin overlay.',
  admin_categories_removed_local: '“{name}” was removed from this browser’s local overlay.',
  admin_categories_hidden_local: '“{name}” is hidden only in this local admin view; the storefront is unchanged.',
  admin_categories_enabled_local: '“{name}” was enabled only in this local admin view.',
  admin_categories_disabled_local: '“{name}” was disabled only in this local admin view; the storefront is unchanged.',
  admin_categories_write_error: 'The local category change could not be stored in this browser.',
  admin_categories_delete_title: 'Delete “{name}”?',
  admin_categories_delete_live_message: 'This only hides the live category in this browser’s admin view. It does not delete it from the API or storefront.',
  admin_categories_delete_local_message: 'This removes the locally created category from this browser. No server data is involved.',
  admin_categories_delete_children_note: ' {count} direct child category(s) will move up one level in this local overlay.',
  admin_categories_delete_confirm: 'Delete locally',
  admin_categories_delete_blocked_products: '“{name}” still contains {count} catalog or local product(s). Reassign those products before deleting the category.',
  admin_categories_disable_title: 'Disable “{name}”?',
  admin_categories_enable_title: 'Enable “{name}”?',
  admin_categories_disable_message: 'This changes only the local admin overlay. The category remains enabled on the live storefront.',
  admin_categories_enable_message: 'This changes only the local admin overlay and does not update the storefront.',
  admin_categories_disable_confirm: 'Disable locally',
  admin_categories_enable_confirm: 'Enable locally'
});
...
Object.assign(I18N.fr, {
  ...
  admin_categories_subtitle: 'Explorez la hiérarchie en ligne et testez des modifications locales.',
  admin_categories_add: 'Ajouter une catégorie',
  admin_categories_local_note_title: 'Prototype frontend',
  admin_categories_local_note: 'Les modifications de catégories restent dans la surcouche admin de ce navigateur et ne modifient jamais l’API ni la boutique.',
  ...
  admin_categories_table_caption: 'Catégories du catalogue en ligne avec les modifications admin locales appliquées',
  ...
  admin_categories_col_source: 'Source',
  admin_categories_col_actions: 'Actions',
  admin_categories_local_edit: 'Modification locale au navigateur',
  ...
  admin_categories_icon_help: 'Uniquement pour cette vue admin locale.',
  admin_categories_field_enabled: 'Activée dans cette vue admin',
  admin_categories_form_note: 'La validation modifie uniquement la surcouche admin locale de ce navigateur.',
  admin_categories_cancel: 'Annuler',
  admin_categories_apply_local: 'Appliquer localement',
  ...
  admin_categories_loading_body: 'Lecture de la hiérarchie en ligne et application de la surcouche locale de ce navigateur.',
  ...
  admin_categories_source_local: 'Local uniquement',
  admin_categories_source_edited: 'En ligne + modif. locale',
  admin_categories_reference: 'ID {id}',
  ...
  admin_categories_saving: 'Application locale…',
  admin_categories_added_local: '« {name} » a été ajoutée uniquement à la surcouche admin de ce navigateur.',
  admin_categories_updated_local: '« {name} » a été modifiée uniquement dans la surcouche admin de ce navigateur.',
  admin_categories_removed_local: '« {name} » a été retirée de la surcouche locale de ce navigateur.',
  admin_categories_hidden_local: '« {name} » est masquée uniquement dans cette vue admin locale ; la boutique reste inchangée.',
  admin_categories_enabled_local: '« {name} » a été activée uniquement dans cette vue admin locale.',
  admin_categories_disabled_local: '« {name} » a été désactivée uniquement dans cette vue admin locale ; la boutique reste inchangée.',
  admin_categories_write_error: 'La modification locale de la catégorie n’a pas pu être stockée dans ce navigateur.',
  admin_categories_delete_title: 'Supprimer « {name} » ?',
  admin_categories_delete_live_message: 'Cette action masque seulement la catégorie en ligne dans la vue admin de ce navigateur. Elle ne la supprime ni de l’API ni de la boutique.',
  admin_categories_delete_local_message: 'Cette action retire la catégorie créée localement de ce navigateur. Aucune donnée serveur n’est concernée.',
  admin_categories_delete_children_note: ' {count} catégorie(s) enfant(s) directe(s) remonteront d’un niveau dans cette surcouche locale.',
  admin_categories_delete_confirm: 'Supprimer localement',
  admin_categories_delete_blocked_products: '« {name} » contient encore {count} produit(s) du catalogue ou local(aux). Réaffectez ces produits avant de supprimer la catégorie.',
  admin_categories_disable_title: 'Désactiver « {name} » ?',
  admin_categories_enable_title: 'Activer « {name} » ?',
  admin_categories_disable_message: 'Cette action modifie uniquement la surcouche admin locale. La catégorie reste activée sur la boutique en ligne.',
  admin_categories_enable_message: 'Cette action modifie uniquement la surcouche admin locale et ne met pas à jour la boutique.',
  admin_categories_disable_confirm: 'Désactiver localement',
  admin_categories_enable_confirm: 'Activer localement'
});
