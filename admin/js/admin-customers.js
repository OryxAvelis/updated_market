 ...
 * Every displayed field is derived from buyer data already present in am_orders.
 */
(() => {
  'use strict';
  ...
  Object.assign(I18N.en, {
    ...
    admin_customers_kicker: 'Order-derived directory',
    admin_customers_title: 'Customers',
    admin_customers_intro: 'Customer records shown here come only from buyer details in local orders.',
    ...
    admin_customers_privacy_note: 'Customer records use order details available on this device; missing buyer fields remain blank.',
    admin_customers_loading: 'Building the local customer directory…',
    admin_customers_table_caption: 'Customers derived from local orders',
    ...
    admin_customers_empty_text: 'Customer records appear only after a local order includes buyer details.',
    ...
    admin_customers_error_title: 'Customers could not be derived',
    admin_customers_error_text: 'The browser-local order data is unavailable or invalid.',
    admin_retry: 'Retry',
    ...
    admin_customers_profile_title: 'Buyer details from local orders',
    ...
    admin_customers_history_title: 'Local order history',
    admin_customers_order: 'Order',
    admin_customers_status: 'Status',
    admin_customers_total: 'Total',
    admin_customers_date: 'Date',
    admin_customers_no_history: 'No local order history is available.',
  ...
  Object.assign(I18N.fr, {
    ...
    admin_customers_kicker: 'Répertoire issu des commandes',
    admin_customers_title: 'Clients',
    admin_customers_intro: 'Les fiches affichées ici proviennent uniquement des coordonnées acheteur des commandes locales.',
    ...
    admin_customers_privacy_note: 'Les fiches clients utilisent les commandes disponibles sur cet appareil ; les informations manquantes restent vides.',
    admin_customers_loading: 'Création du répertoire client local…',
    admin_customers_table_caption: 'Clients issus des commandes locales',
    ...
    admin_customers_empty_text: 'Une fiche apparaît uniquement lorsqu’une commande locale contient des coordonnées acheteur.',
    ...
    admin_customers_error_title: 'Impossible de créer le répertoire client',
    admin_customers_error_text: 'Les données locales de commande sont indisponibles ou invalides.',
    ...
    admin_customers_profile_title: 'Coordonnées acheteur issues des commandes locales',
    ...
    admin_customers_history_title: 'Historique local des commandes',
    admin_customers_order: 'Commande',
    admin_customers_status: 'État',
    admin_customers_total: 'Total',
    admin_customers_date: 'Date',
    admin_customers_no_history: 'Aucun historique local de commande n’est disponible.',
  ...
  function renderCustomers() {
    ...
    body.innerHTML = filtered.map(customer => {
      ...
      return `<tr>
        ...
        <td data-label="${esc(t('admin_customers_col_orders'))}">${esc(t('admin_customers_order_count', { count: customer.orders.length }))}</td>
        ...
        <td data-label="${esc(t('admin_customers_col_latest'))}">${esc(AdminCore.formatDate(latest?.date))}</td>
