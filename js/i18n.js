...
const I18N = {
  en: {
    ...
    shop_now: 'Shop Now',
    ad_label: 'AM MARKET PLUS',
    ad_eyebrow: 'THIS WEEK’S PERK',
    ad_title: 'More in your cart. Less at checkout.',
    ad_copy: 'Enjoy free delivery when your basket reaches 200 DH.',
    ad_cta: 'Start shopping',
    ad_note: 'Delivery across Morocco',
    ...
    card_sub: 'Online payments are coming soon',
    ...
    note_label: 'Delivery note (optional)',
    note_ph: 'Landmark, floor, instructions...',
    // Settings page
    settings: 'Settings',
    set_profile: 'Profile',
    ...
    newsletter_pending: 'Subscriptions are coming soon — thanks for your interest!',
    go: 'Go',
  ...
  fr: {
    ...
    shop_now: 'Acheter',
    ad_label: 'AM MARKET PLUS',
    ad_eyebrow: 'L’AVANTAGE DE LA SEMAINE',
    ad_title: 'Plus dans votre panier. Moins à régler.',
    ad_copy: 'Profitez de la livraison gratuite dès 200 DH d’achats.',
    ad_cta: 'Commencer vos achats',
    ad_note: 'Livraison partout au Maroc',
    ...
    cod_sub: 'Payez à la livraison',
    card_sub: 'Paiement en ligne bientôt disponible',
    ...
    phone_ph: '06 12 34 56 78',
    note_label: 'Note de livraison (optionnel)',
    note_ph: 'Point de repère, étage, instructions...',
    // Page paramètres
    settings: 'Paramètres',
    set_profile: 'Profil',
    ...
    newsletter_pending: 'Les inscriptions arrivent bientôt — merci pour votre intérêt !',
    go: 'OK',
