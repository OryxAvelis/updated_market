...
const I18N = {
  en: {
    ...
    hero_sub: 'Up to 50% OFF on selected items',
    shop_now: 'Shop Now',
    trust1_t: 'Free Delivery', trust1_s: 'On orders over 200 DH',
  ...
  fr: {
    ...
    hero_sub: 'Jusqu’à -50% sur une sélection d’articles',
    shop_now: 'Acheter',
    trust1_t: 'Livraison Gratuite', trust1_s: 'Dès 200 DH d’achat',
